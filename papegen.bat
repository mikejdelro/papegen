...
:dlwf
    ...
    ::[TODO] Need to add a progress bar for this.
    ...
    ::[TODO] Need to figure out error exception and  fallback to Invoke-WebRequest if WebClient.DownloadFile fails
...
cls
ECHO ! ! ! WARNING ! ! !
ECHO We will need to purge your output folder, if you have one. 
ECHO Please make sure to delete/move all your files in %cd%\output
PAUSE
...
::[TODO] This needs to be saved in a config file
:config
...
ECHO ==================================================
    ECHO Instructions:
    ::[TODO] Need to flesh out the instructions.
...
if "%ERRORLEVEL%" == "8" (
    ::[TODO] I actually need to write a README :D
)
